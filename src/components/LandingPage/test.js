...
const loginForm = async (e) => {
  ...
  const sendOtp = async () => {
    if (
      ...
      showError("Please fill all mobile signup fields");
      return;
    }
  ...
  acceptPolicy: "Yes",
      ...
      if (!registerResponse.data.success) {
        showError(registerResponse.data.message || "Mobile registration failed");
        return;
      } */}
  ...
  {
    mobile: Number(String(mobile).replace(/\s/g, "")),
    password: signupMobilePassword,
  }
);
      ...
      if (loginResponse.data.success && loginResponse.data.data) {
        ...
        showSuccess("Mobile signup successful");
        ...
        showError(loginResponse.data.message || "Mobile login failed");
      }
    } catch (error) {
  console.log(
    "Verify OTP backend error:",
    error.response?.data
  );

  console.log(
    "Verify OTP backend full error:",
    error.response
  );
                    ...
                    {signupMode === "mobile" && (
                      <>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setSignupMobilePassword(e.target.value)
                          }
                        />
