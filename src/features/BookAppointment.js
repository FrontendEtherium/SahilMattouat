...
const AppointmentModal = ({ show, onHide, alertBooking, docId }) => {
  ...
  const fetchAppointmentDetails = useCallback(
    async (date) => {
      ...
      try {
        ...
        // Important: load slots for selected date
        const targetDate = date || selectedDate;

        const slotsForDate = Array.isArray(json?.unbookedSlots?.[targetDate])
          ? json.unbookedSlots[targetDate]
          : [];

        setUnbookedSlot(slotsForDate);

        // Clear selected slot if unavailable
    ...
    [docId, selectedDate, selectedTimeSlot],
  );
  ...
  const handleDatesChange = useCallback(
    ...
    [fetchAppointmentDetails, trackEvent],
  );
  ...
  return createPortal(
    <div
      ...
      aria-hidden={!show}
    >
      <div className="modal-dialog appointment-modal-dialog" role="document">
        <div
                ...
                >
                  <div className="d-flex align-items-center">
                    ...
                    <div className="appointment-info-text">
                      ...
                      Choose your preferred date and time slot. After selecting
                      a slot, continue to Step 2 to confirm your booking.
                    </div>
                  </div>
                </div>
                ...
                {showRegistrationCard && (
                  <div className="register-card mb-4">
                    <div className="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between">
                      ...
                      <small className="text-muted mt-2 mt-sm-0">
                        Enter your details to confirm this appointment.
                      </small>
                    </div>

                    <div className="mt-3">
                      {requiresRegistration && !showLogin ? (
                        <>
                            ...
                            <div className="row g-3">
                              ...
                              <div className="col-12 col-md-6">
                                ...
                                <PhoneInput
                                  ...
                                  className="phone-input register-phone"
                            ...
                            <div className="register-footer">
                              <div>
                                <small className="text-muted d-block mb-2">
                                  We’ll send appointment updates to this email
                                  and number.
                                </small>
